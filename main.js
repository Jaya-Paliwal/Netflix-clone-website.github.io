...
const API_KEY = "df328582fb70b9fdb820be9edb6e21bf";
    ...
    movies.map((movie) => {
        ...
        poster.addEventListener("click", function () {
            ...
            if(window.innerWidth > 1100 ){
                ...
                moviePosterImg.src = `${imageUrl}${movie.backdrop_path}`;
            }
...
async function fetchBannerData() {
    ...
    bannerDescription.textContent = `${(select.overview).slice(0,100)}...`;
